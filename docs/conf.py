# -*- coding: utf-8 -*-
#
# bright documentation build configuration file, created by
...
from bright import __version__ as bright_version
...
latex_documents = [
    (master_doc, 'bright.tex', u'bright Documentation',
...
man_pages = [
    (master_doc, 'bright', u'bright Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'bright', u'bright Documentation',
     author, 'bright', 'White dwarf Accretion w/ COSMIC.',
     'Miscellaneous'),
]
